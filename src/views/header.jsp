                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a class="menu-link menu-toggle">
                            <img src="https://cdn.jsdelivr.net/gh/CedtT198/poc-ticketing-assets@main/assets/img/liens/vol_d-avion.png" class="w-px-30 h-auto"/>
                    ...
                    <li class="menu-item">
                        <a href="promotion.jsp" class="menu-link">
                            <img src="https://cdn.jsdelivr.net/gh/CedtT198/poc-ticketing-assets@main/assets/img/liens/promotion.png"class="w-px-30 h-auto"/>
                    ...
                    <li class="menu-item">
                        <a href="const-reservation.jsp" class="menu-link">
                            <img src="https://cdn.jsdelivr.net/gh/CedtT198/poc-ticketing-assets@main/assets/img/liens/reservation_vol.png"class="w-px-30 h-auto"/>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                                ...
                                <img src="https://cdn.jsdelivr.net/gh/CedtT198/poc-ticketing-assets@main/assets/img/profil/admin.png" alt class="w-px-40 h-auto rounded-circle" />
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <form action="signout" method="get" style="text-align:center">
